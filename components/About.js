...
function About() {
  return (
    ...
    max-w-6xl px-10 justify-evenly mx-auto items-center ">
        <h2 className="absolute top-4 uppercase tracking-[20px] text-gray-500 text-2xl">
            About
        </h2>
        <motion.img 
        initial={{
        ...
        viewport={{once:true}} 
        src="/ib.jpg" alt="personal_image" title='Personal_image' className="
        -mb-20 md:mb-0 flex-shrink-0  relative md:top-12
         w-48 h-48 rounded-full md:w-64 md:h-64  xl:-[400px] xl:-[450px] object-fill">

        </motion.img>
        <div className=" md:mb-20 relative md:top-16   ">
        <h4 className='text-center font-bold text-xl sm:text-2xl md:mb-10 mb-4  '>Front End Developer</h4>
        <h4 className='text-center  text-md xl:text-2xl md:text-xl max-w-7xl '>Self-motivated, ambitious, and hard-working individual frontend developer seeking for frontend developer
