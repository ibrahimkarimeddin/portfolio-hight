...
function WorkexpCard() {
  return (
    ...
    cursor-pointer transition-opacity duration-200 overflow-hidden h-[510px] '>
        ...
        title="experince-image" alt="experince-image"
        src="/shop.png" />
        <div className="px-0 md:px-10 ">
            <h4 className='text-4xl font-light text-center'>Ecommerce </h4>
            <p className="text-2xl my-5 font-bold ">Free Lancer</p>
            <div className="flex space-x-[2px] md:space-x-5 my-2 ">
                <img title="experince-image" alt="experince-image" className='h-12 w-12 rounded-full  object-center alt="' 
                src="/nextjs.png"/>
                <img title="experince-image" alt="experince-image" className='h-12 w-12 rounded-full  object-center alt="' 
                src="/redux.jpg"/>
                <img title="experince-image" alt="experince-image" className='h-12 w-12 rounded-full  object-center alt="' 
